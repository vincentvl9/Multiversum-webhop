<?php
	...
	class KassaCompleetPayment
	{
		...
		public function setShipmentData($aShipmentData)
		{
			$this->aShipmentData = $aShipmentData;
		}
		...
		public function getTransaction()
		{
			...
			elseif(empty($this->aCustomerData))
			{
				idealcheckout_log('No Customer data found.', __FILE__, __LINE__);

				$this->aTransaction = array('error' => array('message' => 'No Customer data found.'));
				return false;
			}
