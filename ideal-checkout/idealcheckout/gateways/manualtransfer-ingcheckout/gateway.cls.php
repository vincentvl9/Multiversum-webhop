			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						$oIngCheckout->setPaymentMethod('bank-transfer');
						...
						if($oIngCheckout->getTransaction())
						{
							...
							$this->oRecord['transaction_params'] = $oIngCheckout->getPaymentDetails();
							...
							$this->oRecord['transaction_status'] = $oIngCheckout->getStatus($this->oRecord['transaction_id']);
							$this->save();
							...
							if(($this->oRecord['transaction_status'] == 'PENDING') && ($this->oRecord['gateway_code'] == 'manualtransfer'))
							{
								...
								$sCurrency = $oIngCheckout->getValuta($this->oRecord['currency_code']);
