<?php if(!class_exists('raintpl')){exit;}?><div class="container adminStats">
    <div class="row">
        <div class="col s12 m3 l3 adminStat">
            <h3>Producten</h3>
            <p><?php echo Core::rowsProducts(); ?></p>
        </div>
        <div class="col s12 m3 l3 adminStat">
            <h3>Categorieën</h3>
            <p><?php echo Core::rowsCatogories(); ?></p>
        </div>
        <div class="col s12 m3 l3 adminStat">
            <h3>Voorraad</h3>
            <p><?php echo Core::totalStock(); ?> producten</p>
        </div>
        <div class="col s12 m3 l3 adminStat">
            <h3>Nieuw</h3>
            <p><?php echo Core::addedToday(); ?></p>
        </div>
    </div>
</div>
<div class="row">
